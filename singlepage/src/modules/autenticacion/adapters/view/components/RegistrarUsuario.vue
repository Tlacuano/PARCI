<template>
  <b-modal id="registrarUser" centered title="Registrar Usuario" hide-header-close no-close-on-backdrop no-close-on-esc
    ok-title="Registrar" ok-variant="success" cancel-title="Cancelar" cancel-variant="danger" @ok="onRegistrar"
    ...
    <b-form @submit.prevent="onRegistrar">
      ...
      <b-form-group label="Contraseña">
        <b-input-group>
          <b-form-input :type="mostrarContrasena ? 'text' : 'password'" v-model="usuario.contrasena"
            placeholder="Contraseña" required></b-form-input>
          <b-input-group-append>
            <b-button @click="togglePasswordVisibility" variant="secondary">
              <b-icon :icon="mostrarContrasena ? 'eye-slash-fill' : 'eye-fill'"></b-icon>
            </b-button>
          </b-input-group-append>
        </b-input-group>
      </b-form-group>
      ...
      <b-form-group label="Fecha de Nacimiento">
        <b-input-group class="mb-3">
          <b-form-input v-model="persona.fecha_nacimiento" type="text" placeholder="YYYY-MM-DD"
            autocomplete="off"></b-form-input>
          <b-input-group-append>
            <b-form-datepicker v-model="persona.fecha_nacimiento" button-only right locale="en-US"
